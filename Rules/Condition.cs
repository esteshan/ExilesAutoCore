...
public sealed class Condition
{
    ...
    public bool Evaluate(GameState state)
    {
        ...
        return Kind switch
        {
            ...
            ConditionKind.MonsterIsTargeted => state.Monsters(Range, Rarity).Any(m => m.IsTargeted),
            ConditionKind.MonsterIsTargetable => state.Monsters(Range, Rarity).Any(m => m.IsTargetable),
    ...
    public string Describe() => Kind switch
    {
        ...
        ConditionKind.MonsterIsTargeted => $"A monster ({Rarity}, <={Range}) is targeted",
        ConditionKind.MonsterIsTargetable => $"A monster ({Rarity}, <={Range}) is targetable",
